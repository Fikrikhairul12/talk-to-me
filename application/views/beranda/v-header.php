    ...
    <head>
        <nav>
            <ul class="navbar">
                ...
                <li class="nav-item"><a href="<?=base_url(). 'beranda/index'?>">Beranda</a></li>
                <li class="nav-item"><a href="<?=base_url(). 'mood/index'?>">Mood</a></li>
                <li class="nav-item"><a href="<?=base_url(). 'kalender/index'?>">Aktifitas</a></li>
                <!-- <li class="nav-item"><a href="#">Statistik</a></li> -->
                <li class="nav-item"><a href="<?=base_url(). 'profil/index'?>">Profil</a></li>
